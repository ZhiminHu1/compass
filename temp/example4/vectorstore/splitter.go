...
// SplitConfig configures how documents are split
...
// DefaultConfig returns the default split configuration
...
// SplitDocument splits a document into chunks based on the configuration
func SplitDocument(content string, config SplitConfig) []Chunk {
...
func splitByParagraph(content string, config SplitConfig) []Chunk {
	var chunks []Chunk
...
func splitBySentence(content string, config SplitConfig) []Chunk {
	var chunks []Chunk
...
func handleLargeChunks(chunks []Chunk, config SplitConfig) []Chunk {
	var result []Chunk
